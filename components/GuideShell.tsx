    ...
    >
      <div className="guide-shell relative mx-auto flex min-h-[calc(100dvh-1.5rem-env(safe-area-inset-top,0px)-env(safe-area-inset-bottom,0px))] w-full max-w-md flex-col overflow-hidden rounded-[1.6rem] border border-[#3a3c38] sm:min-h-[calc(100dvh-2.5rem-env(safe-area-inset-top,0px)-env(safe-area-inset-bottom,0px))]">
        <div className="relative z-10 flex items-center justify-between px-5 pb-2 pt-4 text-[10px] uppercase tracking-[0.22em] text-[#9a9b8f]">
          ...
          <span className="text-right text-[#7d806f]">{edition}</span>
        </div>
        ...
        <div className="relative z-10 mx-3 mb-3 flex-1 overflow-hidden rounded-[0.85rem] border border-[#1a1b18] bg-[#151613] p-2 shadow-[var(--inset-shadow)] sm:mx-4 sm:mb-4">
          <div className="guide-screen relative flex h-full min-h-[60dvh] flex-col overflow-hidden rounded-[0.55rem] sm:min-h-[70dvh]">
